...
const Bicycles = () => {
  ...
  return (
    <div className="grid grid-cols-5 gap-5 bg-gray-100 px-5 py-5 md:py-10">
      {/* Queries */}
      <div className="border border-gray-200 bg-white">Queries</div>
      <div className="col-span-4 flex flex-col gap-5">
        ...
        {/* Products */}
        <div className="grid h-full grid-cols-1 border border-gray-200 bg-white md:grid-cols-4">
